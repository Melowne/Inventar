<%@ Page Title="Leipzig-Raum F1" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SitzplanLE_F1.aspx.cs" Inherits="Inventarverwaltung_iad_asp.SitzplanLE_F1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2> Sitzplan Raum F1 Leipzig</h2>
        <div class="Bankreihe">
           <div id="Platz09">
