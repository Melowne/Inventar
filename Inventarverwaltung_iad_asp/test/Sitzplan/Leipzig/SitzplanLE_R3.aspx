<%@ Page Title="Leipzig-Raum R3" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SitzplanLE_R3.aspx.cs" Inherits="Inventarverwaltung_iad_asp.SitzplanLE_R3" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2> Sitzplan Raum R3 Leipzig</h2>
    <div class="Bankreihe">
           <div id="Platz10">
