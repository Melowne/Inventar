<%@ Page Title="Leipzig-Raum F3" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SitzplanLE_F3.aspx.cs" Inherits="Inventarverwaltung_iad_asp.SitzplanLE_F3" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2> Sitzplan Raum F3 Leipzig</h2>
    <div class="Bankreihe">
           <div id="Platz09">
