<%@ Page Title="Leipzig-Raum R5" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SitzplanLE_R5.aspx.cs" Inherits="Inventarverwaltung_iad_asp.SitzplanLE_R5" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2> Sitzplan Raum R5 Leipzig</h2>
        <div class="Bankreihe">
           <div id="Platz08">
