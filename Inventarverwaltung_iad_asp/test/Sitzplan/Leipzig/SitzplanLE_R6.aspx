<%@ Page Title="Leipzig-Raum R6" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SitzplanLE_R6.aspx.cs" Inherits="Inventarverwaltung_iad_asp.SitzplanLE_R6" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2> Sitzplan Raum R6 Leipzig</h2>
        <div class="Bankreihe">
           <div id="Platz08">
    ...
    <div class="Bankreihe">
           ...
           <div class="Gang_large">&nbsp;</div>
    </div>
    <div id="Platz00" style="width:100px;margin-left:300px;">
        <div class="Benutzername">
